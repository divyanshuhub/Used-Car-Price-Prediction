...
model = pickle.load(open('car_price_pridiction_model.pkl', 'rb'))

# define the route(or url) to which we need to send http request
# HTTP GET request method
@app.route('/',methods=['GET'])


# create a funs Home which will return index.html (which contains html
